...
/** Maintains information about a sprite for the GUI. <br>
...
public class Sprite {
	...
	private int cycle= 0;				// Which cycle of the animation are we at now? (in [0,
						 				// cycleSize - 1])
	 ...
	 * Assumes that (dRow, dCol) is the base offset, and subsequent <br>
	 * animations are at (dRow, dCol + 1), (dRow, dCol + 2) ... (dRow, dCol + cycleSize - 1)
	 *
